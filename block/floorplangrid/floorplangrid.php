...
function rentfetch_floorplangrid_block_enqueue() {
    ...
    // Slick
    wp_enqueue_script( 'rentfetch-slick-main-script', RENTFETCH_PATH . 'vendor/slick/slick.min.js', array('jquery'), rf_get_theme_version(), true );
    ...
    wp_enqueue_style( 'rentfetch-slick-main-styles', RENTFETCH_PATH . 'vendor/slick/slick.css', array(), rf_get_theme_version() );
    wp_enqueue_style( 'rentfetch-slick-main-theme', RENTFETCH_PATH . 'vendor/slick/slick-theme.css', array(), rf_get_theme_version() );
