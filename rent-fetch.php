...
/**
 * Should we enable our [verbose] log file(s)?
 *
 * Dependencies:
 *   RENT_FETCH_LOG can be enabled by defining it 'true' in the wp-config.php file.
 */
function rf_is_enable_log() {
    if ( ! defined( 'RENT_FETCH_LOG' ) ) {
        define( 'RENT_FETCH_LOG', false );
    };

    return RENT_FETCH_LOG;
}
